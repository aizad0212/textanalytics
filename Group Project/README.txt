...
- Second, we know we have 8 McDonald's branches with the worst ratings. (Rating < 2.5)
- By taking customer reviews from Google Reviews each branch, we created a dataset for each branch.
...
- Clean up, Standardize and Consolidate the process of using Script_Data Collection to store the dataset in McDonalds_Reviews_Details.xlsx.
